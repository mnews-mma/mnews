...
export const EVENTS: MEvent[] = [
  ...
  {
    // 正式大会名・slugとも未発表。slugは中立形(rizin-omisoka-2026)の仮置きで、
    // 正式発表後に正式slugへ差し替える(このコメントもその際に削除)。
    slug: "rizin-omisoka-2026",
    org: "rizin",
    status: "upcoming",
