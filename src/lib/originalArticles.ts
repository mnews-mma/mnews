...
export const ORIGINAL_ARTICLES: OriginalArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "全10試合の勝敗を予想しました。各選手の戦績・フィニッシュ率・直近の試合内容、AI RIZINランキングの順位などを総合して数値化したAI予想です。",
    ],
    fights: [
      {
      ...
      },
      {
        ...
        confidencePct: 55,
        notablePoints: [
          "アリベク・ガジャマトフは7戦6勝、6勝すべてフィニッシュ。判定までいった勝ち試合が1つもなく、唯一の黒星も2025年9月の扇久保博正戦の判定0-3",
          "対する伊藤裕樹は27戦でフィニッシュされたのが1度だけ(2022年2月の福田龍彌戦)。7敗のうち6は判定で、簡単には倒れない",
          "ガジャマトフの唯一の勝ちパターンであるフィニッシュを、伊藤が最も許しにくいタイプ。決着は判定を想定",
