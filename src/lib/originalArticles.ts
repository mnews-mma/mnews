...
export const ORIGINAL_ARTICLES: OriginalArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "フライ級では、第2試合でイ・ジェフンに3R 4:25 TKO(レフェリーストップ:グラウンドパンチ)で勝利した火の鳥が11位に浮上しています。",
    ],
    rankingSnapshots: [
      {
        divisionLabel: "フライ級",
  ...
  },
  {
    ...
    title: "階級の壁を越えた最強は誰か: AI RIZIN P4Pランキングを読む",
    eventSlug: "rizin-landmark-15",
    publishedAt: "2026-07-27",
    publishedAtTime: "23:30",
    fights: [],
    body: [
      "RIZINには公式のパウンドフォーパウンド(P4P)ランキングが存在しません。mnews.jpのAI RIZIN P4Pランキングは、階級別ランキング(AI RIZINランキング)のレートをもとに階級の壁を取り払い、全選手を横並びで序列化した独自の参考指標です。",
      "現時点(2026-07-25更新)の1位はフェザー級王者ラジャブアリ・シェイドゥラエフ。RIZIN通算7戦7勝で無敗を維持しています。2位には7月18日のRIZIN LANDMARK 15で防衛に成功したバンタム級王者ダニー・サバテロ、3位にライト級王者ルイス・グスタボが続きます。",
      "上位15傑は王者だけで占められているわけではありません。4位イルホム・ノジモフ、5位ホベルト・サトシ・ソウザは、ライト級で王者ルイス・グスタボに次ぐ評価を受けたランクインです。",
      "日本人選手では、6位に井上直樹(バンタム級)、7位に神龍誠(フライ級王者)、8位に朝倉未来(フェザー級)、10位に扇久保博正(フライ級)がランクイン。フェザー級はクレベル・コイケ(9位)、カルシャガ・ダウトベック(11位)、秋元強真(12位)、ヴガール・ケラモフ(13位)と、上位15傑に4名を送り込む最激戦区になっています。",
      "P4Pランキングでは王者も番号付きの順位に含まれ、戦績は階級を問わないRIZIN通算で表示されます。順位は今後の大会結果を受けて随時更新されます。",
    ],
  },
];
