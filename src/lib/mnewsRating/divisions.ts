...
// 2026-07-13: フライ級・バンタム級は資格判定(2025年以降2戦基準)が対戦相手の
// 質を問わないことに起因する体感ズレの精査待ちのため非公開のまま。ライト級は
// 目視レビューで問題なしと確認できたためフェザー級に続いて公開する。
export const PUBLISHED_DIVISIONS: MnewsDivision[] = ["フェザー級", "ライト級"];
