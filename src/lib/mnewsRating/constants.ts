...
//
// 2026-08-13(12→18ヶ月): 全階級横断のlatestBoutDateを基準にしているため、
// 無関係な階級での1大会の反映だけでも窓が前進し、別階級の古いH2Hペアが
// 窓外に押し出されることがある(実例: 野村駿太×パトリッキー・ピットブル
// 2025-07-27戦が、RIZIN.54(全階級横断のlatestBoutDate=2026-08-11)反映で
// 12ヶ月窓からわずか15日差で押し出され、H2H補正が効かなくなった)。掲載資格
// 判定(ELIGIBILITY_MAX_INACTIVE_MONTHS)が既に「直近18ヶ月」を公開文言として
// 使っているため、新しい定数を発明せずこの既存の数字に揃える。
export const MONOTONICITY_H2H_RECENCY_MONTHS = 18;
