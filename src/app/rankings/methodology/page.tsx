    ...
    <>
      ...
      <div className="prose">
        ...
        <h2 style={{ fontSize: 16, fontWeight: 800, marginTop: 32 }}>
          男子パウンドフォーパウンド(P4P)ランキングについて
        </h2>
        <p>
          <a href="/rankings/pound-for-pound" style={{ color: "var(--accent)" }}>P4Pランキング</a>
          は、上記の階級別ランキングの元になっているレートに王座実績を加味して、階級の壁を取り払って全選手を
          横並びにした参考指標です。RIZINに公式のP4Pランキングはありません。
        </p>
        <ul style={{ color: "var(--muted)", lineHeight: 1.9 }}>
          <li>
            RIZIN王座を獲得・防衛した実績を評価します。ベルトを一度も巻いていない選手より、
            防衛を重ねた王者・元王者が上位に来ます。
          </li>
          <li>
            レートは絶対値のまま階級を横断して比較します(階級ごとの平均で正規化はしません)。
          </li>
