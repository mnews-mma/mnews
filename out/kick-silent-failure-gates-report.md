...
origin/main(#563マージ後)にrebaseした状態でローカルにフルパス実行し、**全工程が成功する
ことを確認した**(`next build` は3,819ページを生成、`/kick/fighters` および
`/kick/fighters/[slug]`(3,300選手分)を含む)。
